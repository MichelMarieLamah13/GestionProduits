...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'Gestion Menu', icon: 'align-left', type: 'sub', active: false, children: [
				{
					title: 'Admin', type: 'sub', children: [
						{ path: '/gestion-menu/admin/list-menu', title: 'Menu Lists', type: 'link' },
					],
				},
				{
					title: 'Public', type: 'sub', children: [
		...
		{
			title: 'Gestion Produits', icon: 'box', type: 'sub', active: false, children: [
				{
